...
public static class Drawing
{
    ...
    public static bool FlagPauseDrawing;
    public static bool FlagSkipRescan;
    ...
    public static async Task<bool> Draw(SKBitmap bitmap,Vector2 position)
    {
        ...
        FlagStopDrawing = false;
        FlagPauseDrawing = false;
        FlagSkipRescan = false;
        ...
        foreach (List<Vector2> Action in Actions)
        {
            ...
            {
                // Consume keybind flags (set by MainWindow KeyDown handler)
