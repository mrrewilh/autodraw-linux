...
public enum KeyCode
{
    ...
    VcPeriod = 52,
    VcSlash = 53,
    Vc0 = 11, Vc1 = 2, Vc2 = 3, Vc3 = 4, Vc4 = 5,
    ...
    VcCloseBracket = 35,
    VcQuote = 40,
    VcA = 30, VcB = 48, VcC = 46, VcD = 32, VcE = 18,
    VcF = 33, VcG = 38, VcH = 37, VcI = 24, VcJ = 44,
    VcK = 45, VcL = 46, VcM = 50, VcN = 49, VcO = 25,
    VcP = 26, VcQ = 16, VcR = 19, VcS = 31, VcT = 20,
    VcU = 23, VcV = 47, VcW = 17, VcX = 45, VcY = 21,
    VcZ = 44,
